...
import { createMarkEditableAction } from '../state/contactsActions';
import { createDeleteActionThunk } from '../state/contactActionThunks';
        ...
        <div className="row p-2 border-bottom border-primary">
            ...
            <div className="col-2">
                ...
                <button 
                    ...
                    onClick={event => dispatch(createDeleteActionThunk(contact.id))}>DELETE</button>
            </div>
        </div>
    );
}
